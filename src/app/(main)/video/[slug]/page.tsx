...
import YouTubeEmbed from '@/features/videos/components/YouTubeEmbed';
import type { Metadata } from 'next';
import { getVideo, getRelatedVideos } from '@/features/videos/api';
...
export async function generateMetadata({ params }: VideoDetailPageProps): Promise<Metadata> {
  ...
  return {
    title: `${video.title} | Sahitya Bari`,
...
export default async function VideoDetailPage({ params }: VideoDetailPageProps) {
  ...
  const relatedVideos = await getRelatedVideos(video._id || video.id);
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-8 xl:gap-12">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <MotionDiv
              ...
              className="relative aspect-video rounded-[var(--radius-3xl)] overflow-hidden shadow-2xl liquid-glass border border-[var(--glass-border)]"
            >
              {video.youtubeId ? (
                ...
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                    <div className="liquid-glass px-8 py-4 rounded-[var(--radius-full)] border border-white/20 text-[var(--foreground)] font-black text-xs uppercase tracking-[0.3em] backdrop-blur-xl">
                      Coming Soon
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              {video.description && (
                ...
                >
                  ...
                  <h3 className="text-lg font-bold text-[var(--foreground)] mb-4 flex items-center gap-2 uppercase tracking-widest opacity-50">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {relatedVideos.map((rv: any, idx: number) => (
                    ...
                    >
                      <Link
                        href={`/video/${rv.youtubeId || rv._id || rv.id}`}
