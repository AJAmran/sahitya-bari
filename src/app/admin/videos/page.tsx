...
import { deleteVideo, toggleUpcoming, togglePopular } from "@/features/videos/actions"
import { getVideosFresh } from "@/features/videos/api"
...
export default async function AdminVideosPage({ searchParams }: AdminVideosPageProps) {
  ...
  const { videos, totalPages } = await getVideosFresh({ page: currentPage, limit: 10 });
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-[var(--glass-border)]/50">
              {videos.map((video: any) => (
                <tr key={video._id} className="group hover:bg-[var(--primary)]/[0.02] transition-colors">
                  ...
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-3">
                      <form action={toggleUpcoming.bind(null, video._id)}>
                        <button
                          type="submit"
                      ...
                      <form action={togglePopular.bind(null, video._id)}>
                        <button
                          type="submit"
                  ...
                  <td className="px-8 py-6 text-right">
                    <div className="flex items-center justify-end gap-2 transition-all duration-300">
                      ...
                      <DeleteForm action={deleteVideo.bind(null, video._id)}>
                        <button
                          type="submit"
