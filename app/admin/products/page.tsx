    ...
    <div className="space-y-10 admin-suite">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        <div className="space-y-1">
          ...
          <p className="text-[var(--foreground)]/50 font-medium">Manage your Sahara Bari t-shirts and merchandise.</p>
        </div>
        <Link
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center justify-between py-4 border-y border-[var(--glass-border)]">
                    <div className="space-y-1">
                        <p className="admin-label opacity-40">Stock Status</p>
                    ...
                    <div className="text-right space-y-1">
                         <p className="admin-label opacity-40">Created At</p>
                ...
                <div className="flex flex-wrap gap-1.5 pt-2">
                    {product.sizes?.map((size: string) => (
                        <span key={size} className="px-2 py-0.5 rounded-md bg-[var(--surface-200)]/50 text-[9px] font-bold border border-[var(--glass-border)]">{size}</span>
                    ))}
                </div>
              </div>
            </div>
